        ...
        public static List<scenario> getScripts()
        {
			return new List<scenario>()
			{
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_20070\Map_20070_1\ev_e_0008.json",
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_20031\Map_20031_2\ev_e_0009.json",
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_20030\Map_20030\ev_e_0018.json",
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_30021\Map_30021_10\ev_e_0014.json",
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_20041\Map_20041_3\ev_e_0016.json",
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_30031\Map_30031_5\ev_e_0017.json",
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_30060\Map_30060\ev_e_0020.json",
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_20051\Map_20051_4\ev_e_0021.json",
				...
				new scenario {
					...
					winScript =  @"",
					entityScript = @"Res\Map\Map_30110\Map_30110\ev_e_0027.json",
				...
				new scenario {
					...
					winScript =  @"",
					entityScript = @"Res\Map\Map_30110\Map_30110\ev_e_0028.json",
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_30111\Map_30111_1\ev_e_0029.json",
				...
				new scenario {
					...
					winScript =  @"",
					entityScript = @"Res\Map\Map_20021\Map_20021_1\ev_e_0032.json",
				...
				new scenario {
					...
					winScript =  @"",
					entityScript = @"Res\Map\Map_20011\Map_20011_1\ev_e_0033.json",
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_20011\Map_20011_4\ev_e_0034.json",
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_20011\Map_20011_17\ev_e_0108.json",
					entityIDs = new List<int> { 6 },
					bossBattleBackground = 17,
					bossbgm = 12,
					itemLocations = { },
				...
				new scenario {
					...
					winScript =  @"",
					entityScript = @"Res\Map\Map_30141\Map_30141_5\ev_e_0007.json",
				...
				new scenario {
					...
					winScript =  @"",
					entityScript = @"Res\Map\Map_20151\Map_20151_16\ev_e_0047.json",
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_30151\Map_30151_16\ev_e_0051.json",
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_30151\Map_30151_12\ev_e_0052.json",
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_20161\Map_20161_9\ev_e_0120.json",
					entityIDs = new List<int> { 9 },
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_30181\Map_30181_5\ev_e_0112.json",
				...
				new scenario {
					...
					winScript =  @"",
					entityScript = @"Res\Map\Map_30171\Map_30171_6\ev_e_0056.json",
				...
				new scenario {
					...
					winScript =  @"",
					entityScript = @"Res\Map\Map_30171\Map_30171_6\ev_e_0057.json",
					entityIDs = new List<int> { 10 },
					bossBattleBackground = 19,
					bossbgm = 0,
					itemLocations = { },
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_30221\Map_30221_3\entity_default.json",
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_30231\Map_30231_6\ev_e_0071.json",
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_30251\Map_30251_3\ev_e_0116.json",
					entityIDs = new List<int> { 10 },
					bossBattleBackground = 12,
					bossbgm = 27,
					itemLocations = { },
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_30251\Map_30251_7\ev_e_0117.json",
					entityIDs = new List<int> { 28 },
					bossBattleBackground = 12,
					bossbgm = 27,
					itemLocations = { },
					battleFlagGroupID = 13,
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_30251\Map_30251_16\ev_e_01164.json",
					entityIDs = new List<int> { 3 },
					bossBattleBackground = 12,
					bossbgm = 27,
					itemLocations = { },
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_30251\Map_30251_17\ev_e_0118.json",
				...
				new scenario {
					...
					entityScript = @"Res\Map\Map_30251\Map_30251_18\ev_e_0115.json",
					entityIDs = new List<int> { 6 },
					bossBattleBackground = 14, 
					bossbgm = 27, 
					itemLocations = { }, 
